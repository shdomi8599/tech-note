...
export const COOKAPPS: Category[] = [
  {
    통계: {
      "디에이유 (DAU=Daily Active User)": {
        star: "★★★",
        content:
          "일간 활성 사용자로 하루 동안 게임에 접속하는 사용자 수를 뜻함.",
      },
      ...
      "에이비테스트 (A/B Test)": {
        star: "★★",
        content:
          "유저를 서로 겹치지 않게 두 그룹으로 나누고, 한 쪽은 현재 상태 그대로, 다른 한쪽은 테스트를 하고 싶은 변경 사항을 적용하여 비교하는 테스트 방법",
      },
      "씨비알 (CVR = Conver- sion Rate)": {
        star: "★★",
        content:
          "특정 행위로 유저가 전환되는 비율을 뜻한다. 특정한 전환 액션을 지칭하지 않는 경우, 스토어 설치 전환율 (Store to Install Conver- sion Rate), 즉 앱스토어의 앱 정보 화면의 방문횟수 대비 앱 설치로 연결되는 비율을 의미한다.",
      },
    },
  },
  {
    마케팅: {
      ...
      "에드 네트워크 (Ad Network)": {
        star: "★★★",
        content:
          "다양한 광고주(광고를 내고 싶은 회사)와 광고매체(광고를 실어주고 돈을 받는 회사)를 연결해주는 광고 플랫폼 회사임. 광고주 입장에서는 광고를 다양한 매체의 지면에 알아서 제공해 주기 때문에 좋고, 광고매체 회사에게는 다양한 광고주의 광고를 실을 수 있도록 도와주기 때문에 광고 효율과 수익을 극대화 할 수 있게함.",
      },
      "미디에이션 (Mediation)": {
        star: "★★★",
        content:
  ...
  },
  {
    기획: {
      ...
      "빌드 업데이트 (Buid Update)": {
        star: "★★★",
        content:
          "개발이 완료된 소프트웨어 인 빌드를 구글(안드로이드) 혹은 애플(Ios) 스토어에 올 려 게임을 사용자들에게 배포하는 행위",
      },
      "솔리테어 (Solitaire)": {
        star: "★★★",
        content:
      ...
      "스테이지 (Stage)": {
        star: "★★★",
        content:
          "레벨(Level)들의 묶음을 뜻 하며, 쿡앱스에서는 통상 한 스테이지에 10~15개 레벨로 구성이 되고 해당 스테이지의 모든 레벨 클리어 후 다음 스테이지 이동 시 키(Key)로 오픈 후 이동 가능 하게 되어 있음",
      },
      "앱 이벤트 (App Event)": {
        star: "★★★",
        content:
          "앱 이벤트는 게임(앱)에서 유저의 행위를 의미하며, 보통 페이스북 앱 이벤트를 사용해 유저의 행위를 자세히, 데이터 관점에서 분석할 수 있음.",
      },
      "인게임 (In-Game)": {
        star: "★★★",
        content:
      ...
      "유니티 3D (Unity 3D)": {
        star: "★★★",
        content:
          "쿡앱스 내에서 주로 모바일 게임 제작에 사용되는 엔진을 말함. 현재 WebGL등 대 응을 위한 많은 변화가 이루 어지고 있는 툴이고 모바일 개발, 연출 시 필수적으로 사용하고 있는 툴",
      },
      ...
      "유니티 파티클 시스템 (Unity Particle System)": {
        star: "★★★",
        content:
          "유니티 3D 엔진 내부에 있는 파티클 이펙트 구현 시스템을 말함. 슈리켄이라는 유니티 플러그-인을 인수한 뒤, 유니티 내부엔진에 이식하여서 구현한 툴 임",
      },
      "이펙트 (Effect)": {
        star: "★★★",
        content: "게임 내부에서 발생하는 모든 특수효과를 말함",
      },
      "ASO 이미지 (ASO Image)": {
        star: "★★★",
        content:
          "앱 가시성 향상을 위한 스토어 최적화 이미지를 일컫는 말로 앱아이콘, 스토어 스크린샷 등이 있다.",
      },
      "최적화 (Optimization)": {
        star: "★★★",
        content:
      ...
      "해상도 (Resolution)": {
        star: "★★★",
        content:
          "화면의 세밀함(픽셀수)를 뜻하며 각 기기마다 해상도가 다르다. 단위는 dpi(dot per inch)를 사용하며 모바일 및 웹은 72dpi, 출력물은 200~300 dpi를 사용한다.",
      },
      ...
      "더미 이미지 (Dummy Image)": {
        star: "★★",
        content:
          "제작 전, 또는 제작 중에 완성상태를 예측하기 위하여, 레퍼런스 이미지 또는 작업 그래픽. (원화·UI/UX 애니메이션/이펙트) 중인 스케치, 페인팅 등을 실제 구현환경과 유사하게 꾸며보는 것. “더미를 얹어본 다”란 말이 있음",
      },
    },
  },
  {
    그래픽: {
      ...
      "페이스북 팬페이지 이미지 (Facebook Fan Page Image)": {
        star: "★★",
        content:
          "페이스북에서 서비스 되는 게임들은 게임과 직접적으로 연동할수 있는 App Page가 존재하는데 내부에서는 해당 페이지를 팬 페이지라고 함. 그페이지에 게시되는 이미지 형식의 게시물을 팬 페이지 이미지라고 부름",
      },
    },
  },
  {
  ...
  },
  {
    개발: {
      ...
      "씬 (Scene)": {
        star: "★",
        content:
          "Unity에서 게임 제작을 위해 제공되는 가상 공간으로, 여러 게임 오브젝트들이 구성되어 게임의 형태가 표현되는 공간이다.",
      },
      ...
      "피에스티 (PST=Pacific Standard Time)": {
        star: "★",
        content:
          "페이스북에서 사용하는 시간으로 태평양 표준 시간(대한민국 시간 -16시간)을 의미함",
      },
    },
  },
  {
    경영지원: {
      ...
      "비이피 (BEP=Break Even Point)": {
        star: "★★★",
        content: "손익분기점을 뜻하며, 수익 - 비용 = 0이 되는 시점을 말함.",
      },
      "연말정산 (Year-end Tax Adjustment)": {
        star: "",
        content:
          "국세청에서 1년 동안 간이세액표에 따라 거둬드인 근로 소득세를 연말에 다시 계산하여 실제 소득보다 많은 세금을 냈으면 돌려주고 적게 거뒀으면 더 징수하는 절차",
      },
      ...
      "손익계산서 (Income Statement)": {
        star: "",
        content:
          "일정기간동안 기업의 경영성과에 대한 정보를 제공하는 보고서로 수익과 비용을 대응시켜 손익을 표시 (*구조 : 매출액-매출원가= 매출총이익-판매비와 관리 비=영업이익+영업외수익- 영업외비용=법인세차감전 순이익-법인세비용=당기순 이익) 경영지원. (회계)",
      },
    },
  },
  {
    기타: {
      ...
      "티씨 (Test Case)": {
        star: "★★★",
        content:
          "각종 상황과 시나리오를 테스팅하기 위해 만들어 놓는 문서(또는 집합)를 뜻함. 각 기능별 상황(Steps)과 예상 결과, 사전 조건, 처리 결과 등의 항목으로 구성되어 있다.",
      },
      "버그 (Bug)": {
        star: "★★",
        content:
          "의도되지 않게 작성된 코드나 알고리즘으로 인해 발생되는 각종 결함을 뜻함. a.소프트웨어적 결함이라고 이해하면 쉽게 이해할 수 있음 b.단, 예외적인 경우도 있기 때문에 개발자만의 문제로 잡지 않아야 함",
      },
